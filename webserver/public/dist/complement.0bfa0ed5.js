...
var styler = popmotion.styler,
    timeline = popmotion.timeline,
    listen = popmotion.listen,
    easing = popmotion.easing;
console.log(window);
...
var modalShade = styler(document.querySelector('.modal-shade'));
var modalContainer = styler(document.querySelector('.modal-container'));
var modal = styler(document.querySelector('.modal'));
var modalSections = Array.from(document.querySelector('.modal').children).map(styler);
...
var showContainers = function showContainers() {
  modalShade.set('display', 'block'); //modalShade.set('display', 'block');
...
listen(okModalButton, 'click').start(okModal); //  This is end of popmotion example code
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","complement.js"], null)
//# sourceMappingURL=/complement.0bfa0ed5.js.map